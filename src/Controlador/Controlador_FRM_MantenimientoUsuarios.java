...
public class Controlador_FRM_MantenimientoUsuarios implements ActionListener {
    ...
    public Controlador_FRM_MantenimientoUsuarios(FRM_MantenimientoUsuarios mantenimientoUsuarios, ConexionBD conexion, MetodosUsuarios metodosUsuarios, ArchivosUsuarios archivoUsuarios, Metodos_XML_Usuario metodos_XML_Usuario) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Agregar")) {
            ...
            if (archivoElegido == 1) {
                ...
                this.metodos_XML_Usuario.guardarEnXML(mantenimientoUsuarios.devolverInformacion());
                this.mantenimientoUsuarios.limpiar();
                this.mantenimientoUsuarios.estadoInicial();
            }
        ...
        if (e.getActionCommand().equals("Modificar")) {
            ...
            if (archivoElegido == 1) {
                ...
                //this.metodos_XML_Usuario.modificarInformacionDelXml(this.mantenimientoUsuarios.devolverIDUsuario(),this.mantenimientoUsuarios.devolverPassword(),this.mantenimientoUsuarios.devolverNombre(),this.mantenimientoUsuarios.devolverApellidos());
            }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void buscarXML() {
        if (this.metodos_XML_Usuario.consultarInformacionDelXml(this.mantenimientoUsuarios.devolverIDUsuario())) {
            this.mantenimientoUsuarios.mostrarInformacion(this.metodos_XML_Usuario.getArregloInformacion());
            this.mantenimientoUsuarios.habilitarOpciones();
            this.mantenimientoUsuarios.deshabilitarSigla();
            this.mantenimientoUsuarios.mostrarMensaje("El Usuario con nombre de usuario: " + this.mantenimientoUsuarios.devolverIDUsuario() + " se encuentra registrado");
        } else {
