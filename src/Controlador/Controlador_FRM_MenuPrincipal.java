...
public class Controlador_FRM_MenuPrincipal implements ActionListener {
    ...
    public Controlador_FRM_MenuPrincipal(FRM_MenuPrincipal menuPrincipal) {
        ...
        this.mantenimientoUsuarios = new FRM_MantenimientoUsuarios(conexion, metodosUsuarios, archivosUsuarios, metodos_XML_Usuario);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Matricula")) {
            ...
            this.mantenimientoMatricula.controlador_FRM_Matricula.metodosMatricula.setArray(this.mantenimientoMatricula.controlador_FRM_Matricula.archivoMatricula.devolverInformacionDelArchivoMatricula());
